...
describe ExpensesController do
  ...
  let(:valid_attributes) { { "date" => "2013-05-18 20:30:35" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved expense as @expense" do
        ...
        post :create, {:expense => { "date" => "invalid value" }}, valid_session
        assigns(:expense).should be_a_new(Expense)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested expense" do
        ...
        Expense.any_instance.should_receive(:update_attributes).with({ "date" => "2013-05-18 20:30:35" })
        put :update, {:id => expense.to_param, :expense => { "date" => "2013-05-18 20:30:35" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the expense as @expense" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Expense.any_instance.stub(:save).and_return(false)
        put :update, {:id => expense.to_param, :expense => { "date" => "invalid value" }}, valid_session
        assigns(:expense).should eq(expense)
      end
